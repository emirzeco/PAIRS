...
**Analyses are restricted to working-age respondents (20–60) who are in a cohabiting or marital relationship and not in education**
...
benefit_components <- uk %>%
  ...
  summarise(
    ...
    Child_Tax_Credit = round(
      100 * mean(check_CTC == 1),
      1
    ),
...
benefit_time_series_components <- uk %>%
  ...
  summarise(
    ...
    CTC_unweighted = sum(check_CTC == 1, na.rm = TRUE),
    CTC_weighted = sum(weight_cs * (check_CTC == 1), na.rm = TRUE),
